...
private val IMAGE_PADDING = 100f.pxtodp
...
class XfermodeView(context: Context,attrs: AttributeSet): View(context,attrs) {
    ...
    val rectf = RectF(0f.pxtodp, 0f.pxtodp, 400f.pxtodp, 400f.pxtodp)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        //画 正方形
        canvas.drawRect(IMAGE_PADDING-75f.pxtodp,
            IMAGE_PADDING+75f.pxtodp, IMAGE_WIDTH-75f.pxtodp + IMAGE_PADDING,
            IMAGE_WIDTH + IMAGE_PADDING+75f.pxtodp,paint)
        paint.xfermode = null
